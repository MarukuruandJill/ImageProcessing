    ...
    static MyImage execute(MyImage input1, MyImage input2, MyImage input0) {
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                ...
                if ((height / 4 < i) && (i < height1 + height / 4) && (width / 4 < j) && (j < width1 + width / 4)) {

                    Color color0 = input0.getColor(j - width / 4, i - height / 4);
                    ...
                    if (color0.getRed() > 0) {
                        ...
                        if (i > height2 && j > width2) {
                            ...
                            Color color1 = input1.getColor(j - width / 4, i - height / 4);
